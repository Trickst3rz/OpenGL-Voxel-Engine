...
std::vector<unsigned short> Renderer::IndicesFront = {
		//Front 
		0, 1, 2,
		2, 3, 0,
};

std::vector<unsigned short> Renderer::IndicesBack = {
		//Back
		4, 5, 6,
		6, 7, 4,
};

std::vector<unsigned short> Renderer::IndicesRight = {
		//Right
		8, 9, 10,
		10, 4, 8,
};

std::vector<unsigned short> Renderer::IndicesLeft = {
		//Left
		11, 2, 12,
		12, 13, 11,
};

std::vector<unsigned short> Renderer::IndicesBottom = {
		//Bottom
		10, 14, 5,
		5, 4, 10,
};

std::vector<unsigned short> Renderer::IndicesTop = {
	//Top
